...
while [ "$i" -lt $1 ]; do
    echo "start node $i..."
    #python3 run_socket_node.py --sid 'sidA' --id $i --N $1 --f $2 --B $3 --S 100 --P "td" --D True --O True --C $4 &
    #python3 run_socket_node.py --sid 'sidA' --id $i --N $1 --f $2 --B $3 --S 100 --P "td_1" --D True --O True --C $4 &
